  ...
  return (
    <section id="home" className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 via-white to-cyan-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            ...
            className="group flex items-center space-x-2 px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full transition-all duration-300 hover:shadow-xl hover:scale-105 text-lg font-medium"
          >
          ...
          <button
            ...
            className="px-8 py-4 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-900 dark:text-white rounded-full transition-all duration-300 hover:shadow-xl border border-gray-200 dark:border-gray-700 text-lg font-medium"
          >
            View Our Services
          </button>
        </div>
